<script>
    ...
    function draw() {
        ...
        ctx.translate(-quadratoX, -quadratoY)
        ctx.drawImage(snake, quadratoX - raggio, quadratoY - raggio, 2 * raggio, 2 * raggio);
        ctx.restore();
...
<div style="display:none;">
  <img bind:this={snake} id="source" src="/imgs/snake2.png" width="640" height="640" alt="snake">
  <img bind:this={erba} id="erba" src="/imgs/erba.jpg" width="970" height="545" alt="erba">
</div>